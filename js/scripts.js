...
// https://resources.dgmuvu.com/presidents/

import {presidents} from '../data/presidents.js';
// console.log(presidents)

const pathStatrt = "https://www.loc.gov/static/portals/free-to-use/public-domain/presidential-portraits/"
...
for (let x = 0; x < presidents.length; x++) {
    ...
    myImage.setAttribute("src", pathStatrt + presidents[x].photo);
    myImage.setAttribute("alt", presidents[x].name);

    let myCaption = document.createElement('figcaption');
    myCaption.innerHTML = `Served ${presidents[x].took_office} to ${presidents[x].took_office} <br> 
